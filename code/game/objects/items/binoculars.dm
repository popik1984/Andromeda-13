...
/obj/item/binoculars/proc/on_wield(obj/item/source, mob/user)
	user.visible_message(span_notice("[user] подносит [declent_ru(ACCUSATIVE)] к глазам."), span_notice("Вы подносите [declent_ru(ACCUSATIVE)] к глазам."))
...
/obj/item/binoculars/proc/on_unwield(obj/item/source, mob/user)
	user.visible_message(span_notice("[user] опускает [declent_ru(ACCUSATIVE)]."), span_notice("Вы опускаете [declent_ru(ACCUSATIVE)]."))
	inhand_icon_state = "binoculars"
	user.regenerate_icons()
