...
/datum/surgery_step/experimental_dissection/success(mob/user, mob/living/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	user.visible_message(span_notice("[user] препарирует [target], обнаруживая [points_earned] очков исследований!"), span_notice("You dissect [target], обнаруживая [points_earned] очков исследований, вы также пишете несколько заметок."))
