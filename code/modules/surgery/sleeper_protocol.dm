...
/obj/item/disk/surgery/sleeper_protocol/get_ru_names()
	return list(
		...
		ACCUSATIVE = "подозрительный хирургический диск",
		INSTRUMENTAL = "подозрительным хирургическим диском",
		PREPOSITIONAL = "подозрительном хирургическом диске",
	)
...
/datum/surgery_step/brainwash/sleeper_agent
	...
	var/static/list/possible_objectives = list(
		"Ты любишь Синдикат.",
		"Недоверяй Нанотрейзен.",
		"Капитан - ящер.",
		"Нанотрейзен не существует.",
