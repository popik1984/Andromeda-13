...
/datum/surgery_step/apply_bioware/imprint_cortex/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		span_notice("Вы начинаете вырезать на внешней коре головного мозга [target] самопечатающийся шаблон."),
		span_notice("[user] начинает вырезать на внешней коре головного мозга [target] самопечатающийся шаблон."),
...
/datum/surgery_step/apply_bioware/imprint_cortex/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_results(
		user,
		target,
		span_notice("Вы преобразуете внешнюю кору головного мозга [target] в самопечатающийся шаблон!"),
		span_notice("[user] перестраивает внешнюю кору головного мозга [target] в самопечатающийся шаблон!"),
