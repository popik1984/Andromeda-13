...
/datum/surgery_step/apply_bioware/reshape_ligaments/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		span_notice("Вы начинаете придавать связкам [target] форму крючка."),
		span_notice("[user] начинает перестраивать связки [target], придавая им форму крючка."),
		span_notice("[user] начинает манипулировать связками [target]."),
	)
...
/datum/surgery_step/apply_bioware/reshape_ligaments/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_results(
		user,
		target,
		span_notice("Вы придаете связкам [target] форму крючка!"),
		span_notice("[user] придает связкам [target] форму крючка!"),
		span_notice("[user] заканчивает манипулирование связками [target]."),
	)
