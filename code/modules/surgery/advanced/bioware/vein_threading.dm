...
/datum/surgery_step/apply_bioware/thread_veins/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		span_notice("Вы начинаете плести кровеносную систему [target]"),
		span_notice("[user] начинает плести кровеносную систему [target]."),
...
/datum/surgery_step/apply_bioware/thread_veins/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_results(
		user,
		target,
		span_notice("Вы сплетаете кровеносную систему [target] в прочную сеть!"),
		span_notice("[user] сплетает кровеносную систему [target] в прочную сеть!"),
		span_notice("[user] завершает манипуляцию кровеносной системой [target]."),
	)
