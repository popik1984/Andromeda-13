...
/datum/surgery_step/apply_bioware/muscled_veins/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		span_notice("Вы начинаете обматывать мышцами кровеносную систему [target]."),
		span_notice("[user] начинает обматывать мышцами кровеносную систему [target]."),
		span_notice("[user] начинает манипулировать кровеносной системой [target]."),
	)
...
/datum/surgery_step/apply_bioware/muscled_veins/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_results(
		user,
		target,
		span_notice("Вы изменяете кровеносную систему [target], добавляя мышечную мембрану!"),
		span_notice("[user] изменяет кровеносную систему [target], добавляя мышечную мембрану!"),
		span_notice("[user] заканчивает манипулировать кровеносной системой [target]."),
	)
