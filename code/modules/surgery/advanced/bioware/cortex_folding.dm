...
/datum/surgery_step/apply_bioware/fold_cortex/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		span_notice("Вы начинаете складывать внешнюю кору головного мозга у [target] во фрактальный узор."),
		span_notice("[user] начинает складывать внешнюю кору головного мозга у [target]  во фрактальный узор."),
...
/datum/surgery_step/apply_bioware/fold_cortex/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_results(
		user,
		target,
		span_notice("Вы складываете внешнюю кору головного мозга у [target] во фрактальный узор!"),
		span_notice("[user] складывает внешнюю кору головного мозга у [target] во фрактальный узор!"),
