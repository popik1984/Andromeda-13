...
/datum/surgery_step/viral_bond/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		span_notice("Вы начинаете нагревать костный мозг у [target] с помощью [tool.declent_ru(GENITIVE)]..."),
		span_notice("[user] начинает нагревать костный мозг у [target] с помощью [tool.declent_ru(GENITIVE)]..."),
		span_notice("[user] начинает нагревать что-то в груди у [target] с помощью [tool.declent_ru(GENITIVE)]..."),
	)
...
/datum/surgery_step/viral_bond/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results)
	display_results(
		user,
		target,
		span_notice("Костный мозг у [target] начинает медленно пульсировать. Вирусная связь завершена."),
		span_notice("Костный мозг у [target] начинает медленно пульсировать."),
